...
// Update GPIO definitions for ESP32-S3
...
// Update reserved GPIOs for ESP32-S3
#define RESERVED_GPIO_APP (1ULL<<RFOUT_GPIO|1ULL<<RFIN_GPIO|1ULL<<BUTTON_GPIO|gpio_cfg->gpio_in_use)
#define RESERVED_GPIO_SPI (BIT64(11)|BIT64(12)|BIT64(13)|BIT64(14)|BIT64(15)|BIT64(16))

#define gpioUnUsuable (BIT64(0)|BIT64(1)|BIT64(2)|BIT64(3)|BIT64(4)|BIT64(5)|BIT64(6)|BIT64(7)|BIT64(8)|BIT64(9)|BIT64(10)|RESERVED_GPIO_SPI|RESERVED_GPIO_APP)
#define gpioUsable ((BIT64(GPIO_NUM_MAX)-1) & ~gpioUnUsuable)

uint64_t inputGpioUsable;
uint64_t outputGpioUsable;
static uint64_t pins_in_use, pins_not_cli;
